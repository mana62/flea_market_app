    ...
    <section class="item-detail__right"> 
        ...
        <section class="item-detail__actions">
            ...
            <div class="item-detail__likes-count">
                <button data-item-id="{{ $item->id }}" class="like-btn {{ Auth::user()->likedItems->contains($item->id) ? 'liked' : '' }}">
        ...
        <section class="item-detail__purchase">
            <form action="{{ route('item.purchase', $item->id) }}" method="post" class="item-detail__purchase-form">
                @csrf
        ...
        <article class="item-detail__comments"> <!-- コメント -->
            ...
            <section class="item-detail__comment">
                <div class="comment-header">
                    ...
                    <img src="{{ $comment->user->profile->image }}" alt="{{ $comment->user->name }}" class="comment-user-image">
                    @else
